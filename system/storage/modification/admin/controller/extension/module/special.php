...
class ControllerExtensionModuleSpecial extends Controller {
	...
	public function index() {
		$this->load->language('extension/module/special');
				...
				$data['entry_product_timers'] = $this->language->get('entry_product_timers');
		...
		if (isset($this->request->post['status'])) {
			...
			$data['status'] = '';
				...
				if (isset($this->request->post['product_timers'])) {
				$data['product_timers'] = $this->request->post['product_timers'];
				} elseif (!empty($module_info)) {
				$data['product_timers'] = $module_info['product_timers'];
				} else {
				$data['product_timers'] = '';
				}
