...
class ModelWkposWkpos extends Model {
	...
	public function createTables() {
		...
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "wkpos_products` (
		  ...
		  `quantity` int(11) NOT NULL,
			`status` tinyint(1) NOT NULL,
		  `unit_price_status` tinyint(1) NOT NULL,
		  `outlet_id` int(11) NOT NULL,
		...
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "wkpos_order_product_weight` (
			`order_product_weight` int(11) NOT NULL AUTO_INCREMENT,
			`customer_id` int(11) NOT NULL,
			`order_id` int(11) NOT NULL,
			`product_id` int(11) NOT NULL,
			...
			PRIMARY KEY (`order_product_weight`)
		) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=1");
		// Update code ended
	...
	public function deleteTables() {
		...
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "wkpos_order_product_weight`");
	}
}
