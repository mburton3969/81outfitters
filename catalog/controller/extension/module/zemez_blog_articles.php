...
class ControllerExtensionModuleZEMEZBlogArticles extends Controller
{
	...
	public function index($setting)
	{
		...
		$data['articles']             = array();
		$data['heading_blog_title']        = $this->language->get('heading_blog_title');
		...
		foreach ($results as $result) {
			...
			if ($setting['show_image'] == 1 && $result['featured_image'] ) {
				...
				$image = $this->model_tool_image->resize('catalog/blog/no_image.png', 1025, 494);
			}
